...
I18N.conf = {
     ...
     * 未登录首页 /
     */
    rePagePath: /\/(notifications|watching|stars|issues|search|pulls|trending|showcases|$|new\/import|settings|releases)/,
...
I18N.zh = {
    ...
    "pubilc": { // 公共区域翻译         //页面顶端黑色的部分拉取请求 问题 广场 探索
        "static": { // 静态翻译
            // 未登录部分
            "Personal": "个人",
            "Open source": "开源",
            ...
            "Edit":"编辑",
            "Website":"网站",
            "Website for this repository (optional)":"这个仓库相关的网站(可选)",
            "Save":"保存",
            "or":"或者",
            "Cancel":"取消",
            "Branch:":"分支:",
            ...
            "Tags":"标签",
            "default":"默认",
            "New pull request":"建立合并请求",
            "Create new file":"新建文件",
            "Upload files":"上传文件",
            "Find file":"查找文件",
            "Clone or download":"克隆 或者 下载",
            "Clone with HTTPS":"克隆和HTTPS",
            "Which remote URL should I use?":"我应该使用哪种远程地址",
            "Use SSH":"使用SSH",
            "Use Git or checkout with SVN using the web URL.":"使用这个网页URL的Git或SVN获取资源",
            "Open in Desktop":"GitHub Desktop下载",
            "Open in Visual Studio":"在 VS 中打开",
            "Download ZIP":"直接下载为压缩包",
            "Latest commit":"最新提交于 ",
            "last month":"上个月",
            "Help people interested in this repository understand your project by adding a README.":"通过Readme让人们对这个项目更加感兴趣",
            "No releases published":"没有任何发新版本",
            "Create a new release":"创建一个发行版本",
            "No packages published":"没有发布任何包",
            "Publish your first package":"公开你的第一个包",
            "Add file":"添加文件",
            "Go to file":"转到文件",
            ...
            "Focusing":"专注的",
            "Busy":"很忙",
            "When others mention you, assign you, or request your review, GitHub will let them know that you have limited availability.": "当其他人需要让你上线时,GitHub将告诉他们您现在没时间",
            "Clear status":"清除状态",
            "Never":"暂时不",
            "Keep this status until you clear your status or edit your status.": "保持当前状态,直到清空或修改当前状态.",
            ...
            "Add header text": "标题",
            "Add bold text <ctrl+b>": "加粗 <cmd+b>",
            "Add italic text <ctrl+i>": "斜体 <cmd+i>",
            "Insert a quote": "插入引用",
            "Insert code": "插入代码",
            "Add a link <ctrl+k>": "链接 <ctrl+k>",
    ...
    "page-profile": { // 个人首页 //github.com/某某莫
        "static": { // 静态翻译
            ...
            "Customize your pins": "自定义您的固定仓库",
            "Repositories contributed to": "贡献过的仓库",
            "Contribution activity": "贡献信息",
            
            "Edit pinned items": "编辑固定仓库",
            "Filter repositories and gists": "过滤仓库和介绍",
            "You can now pin up to 6 repositories.": "你现在可以设置6个固定仓库。",
            "Select up to six public repositories or gists you’d like to show.": "最多可选择六个要显示的公共仓库。",
            //"Show:": "显示:",
            //"Your repositories": "您的的仓库",
            //"Repositories you contribute to": "您贡献过的仓库",
            "Save pins": "保存固定仓库",
            "Your pins have been updated. Drag and drop to reorder them.": "您的首页已更新,拖放后重新排序",
            
            //不生效 因为这是网页加载完成之后才加载出现的内容
            "Code review":"代码审查",
            "Commits":"提交",
            "Issues":"提问",
            "Pull requests":"引入请求",
            ...
            "Turning on private contributions will show anonymized private activity on your profile.":"打开私人贡献将显示在您的个人资料匿名的私人活动.",
            "Activity overview":"活动概述",
            "Turning off the activity overview will hide the section on your profile.": "关闭活动概览将隐藏个人资料中的部分.",
            ...
            "Others will now see 'Activity overview' when they view your profile.": "其他人在查看您的个人资料时,将看到“活动概览”",
            ...
            // 包 tags
            "Search packages…":"搜索包…",
            "Get started with GitHub Packages":"开始使用GitHub包",
            "Learn more":"了解更多",
            "Package type:":"包的类型:",
            ...
            // 粉丝 tag
            "You don’t have any followers yet.":"您还没有任何的追随者呢.",
            "about being social on GitHub.":"关于Github的社交.",
            
            // 关注 tag
            "You aren’t following anybody.":"您没有关注任何人"
        },
        "regexp": [ // 正则翻译
    ...
    "page-new-repo": { // 新建仓库  //https://github.com/new
        "static": { // 静态翻译
            "Create a new repository": "创建一个新的仓库",
            "A repository contains all project files, including the revision history. Already have a project repository elsewhere?": "仓库包含项目中的所有文件，包括修订历史记录,在其他地方已经有项目存储库了吗？",
            "Import a repository.": "导入一个仓库",
            "Owner": "创建者",
            "Repository name": "仓库名",
            ...
            "Skip this step if you’re importing an existing repository.":"如果您要提交已有的仓库，请忽略这个选项.",
            "This will let you immediately clone the repository to your computer.":"这将让您可以立刻克隆该仓库到您的电脑.",
    ...
    "vis-public": { // 仓库页
        "static": { // 静态翻译
            ...
            "Moderation":"合理限制",
            "Interaction limits":"访问者限制",
            
            "Temporary interaction limits":"暂时限制交互功能",
            
            
            "Template repository":"仓库模板",
            "Template repositories let users generate new repositories with the same directory structure and files. Indicate if":"仓库模板让用户生成相同的目录结构和文件的新仓库,选择是否将:",
            "can be used as a template for creating other repositories.":"作为用于创建其他仓库的模板",
            "Social preview":"公开预览",
            
            "Upload an image to customize your repository’s social media preview.":"上传图片来自定义公开预览中的信息",
            "Images should be at least 640×320px (1280×640px for best display).":"图片最少要640*320像素(1280*640像素会有最好的预览信息)",
            ...
            "Issues integrate lightweight task tracking into your repository. Keep projects on track with issue labels and milestones, and reference them in commit messages.":"添加轻量级问题跟踪紧密集成的问题。添加里程碑的问题，标签问题，并密切与参考问题提交消息",
            "Get organized with issue templates":"使用贡献者问题模板",
            "Give contributors issue templates that help you cut through the noise and help them push your project forward.":"给贡献者问题模板,方便他们反馈问题,以便推进更新您的项目",
            "Set up templates":"设置模板",
            "Sponsorships":"赞助",
            "Sponsorships help your community know how to financially support this repository.":"赞助可以帮助您的社区了解如何在财务上支持该存储库.",
            "Display a \"Sponsor\" button":"显示一个\"赞助商\"按钮",
            "Add links to GitHub Sponsors or third-party methods your repository accepts for financial contributions to your project.":"将支付链接添加到赞助区域,使您的项目支持第三方的赞助方式",
            "Set up sponsor button":"设置赞助商按钮",
            "Project boards on GitHub help you organize and prioritize your work. You can create project boards for specific feature work, comprehensive roadmaps, or even release checklists.":"GitHub上的项目板可帮助您组织工作并确定其优先级。 您可以为特定功能工作，综合路线图甚至发布清单创建项目板。",
            "Data services":"数据服务",
            "Use the data from your repository to power these enhanced features.":"使用仓库中的数据来增强这些功能",
            "Security alerts":"安全警报",
            "Receive alerts when a new vulnerability is found in one of your dependencies.":"在您的一个依赖项中发现新漏洞时接收警报.",
            "Preserve this repository":"保留该仓库",
            "Include this code in the":"将代码包含在",
            "GitHub Archive Program.":"GitHub存档程序",
            "When merging pull requests, you can allow any combination of merge commits, squashing, or rebasing. At least one option must be enabled. If you have linear history requirement enabled on any protected branch, you must enable squashing or rebasing.":"合并拉取请求时，可以允许合并提交，压缩或变基的任何组合。 至少必须启用一个选项。 如果在任何受保护分支上启用了线性历史记录要求，则必须启用挤压或重新基准。",
            "Allow rebase merging":"允许合并基准",
            "Add all commits from the head branch onto the base branch individually.":"将head分支中的所有提交分别添加到base分支中。",
            "After pull requests are merged, you can have head branches deleted automatically.":"合并请求请求后，可以自动删除头分支。",
            "Automatically delete head branches":"自动删除分支头",
            "Deleted branches will still be able to be restored.":"删除的分支仍将能够还原。",
            "GitHub Pages is currently disabled. Select a source below to enable GitHub Pages for this repository.":"GitHub Pages目前已禁用。 在下面选择一个源以为此存储库启用GitHub Pages。",
            "Theme Chooser":"主题选择器",
            "Select a theme to publish your site with a Jekyll theme using the":"选择一个主题，以使用Jekyll主题发布您的网站为",
            "Choose a theme":"选择一个主题",
            "Hide this repository from the public.":"对公众隐藏此存储库。",
            "Transfer this repository to another user or to an organization where you have the ability to create repositories.":"将此存储库转移到另一个用户或您可以创建存储库的组织。",
            "Archive this repository":"存档这个仓库",
            "Mark this repository as archived and read-only.":"将此存储库标记为已归档和只读。",
    ...
    "homepage": { // 未登录首页     //已登录首页https://github.com/
        "static": { // 静态翻译
            ...
            "Repositories":"仓库",
            "New":"新建",
            "Find a repository…":"查找一个仓库…",
            "Working with a team?":"与团队协作?",
            "GitHub is built for collaboration. Set up an organization to improve the way your team works together, and get access to more features.": "GitHub是为协作而建立的,建立组织以改善团队合作的方式,并获得更多的功能.",
            "Create an organization":"创建团队组织",
            "Explore repositories":"探索仓库",
            "Explore more →":"探索更多 …",
            "Subscribe to your news feed":"从这里订阅您的新闻",
            "The feed shows you events from people you":"该页面向您显示您",
            "follow":"关注",
            "and repositories you":"的人,和",
            "watch":"订阅的仓库",
            "ProTip!":"专业提示",
    ...
    // "settings":{ // 自己的仓库设置页面  https://github.com/username/xiangmu/settings
    //     "static":{
    //         "":"",
    //     },
    //     "regexp":[
...
I18N.zh["settings"] = I18N.zh["vis-public"];